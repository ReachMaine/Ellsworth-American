...
<div class="prl-container">
    <div class="prl-grid prl-grid-divider">
    	<?php  if (isset($prl_data['banner_top_cat']) && $prl_data['banner_top_cat']!='') echo '<div id="archive-top-ad" class=prl-span-12> <div class="ads_top ad-container">'.do_shortcode(stripslashes($prl_data['banner_top_cat'])).'</div></div>';  ?>
