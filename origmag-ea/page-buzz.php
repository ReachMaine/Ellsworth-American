<?php
/*
Template Name: Page - Buzz
*/
 /*
		21May19 zig - copied default page template
*/
?>
<?php get_header();?>
<div class="prl-container">
    <div class="prl-grid prl-grid-divider">
      ...
      <?php /* zig - use "special banner" from widget area */
        if (is_active_sidebar('eai-buzz-topad')) {
          dynamic_sidebar( 'eai-buzz-topad' );
        } else { echo "<!-- no buzz yet -->"; }
      ?>
