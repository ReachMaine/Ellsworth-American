...
<?php
    ...
    <div class="prl-grid prl-grid-divider">
		...
		<div class="prl-span-4">
            ...
            <?php
			$recent_post1 = new WP_Query(array('post_type' => 'post','showposts' => 1,'post__not_in' => get_option('sticky_posts'),'cat' => $category1, 'no_found_rows' => TRUE));
			$p=0;
		...
		<div class="prl-span-4">
            ...
            <?php
			$recent_post2 = new WP_Query(array('post_type' => 'post','showposts' => 1,'post__not_in' => get_opton('sticky_posts'),'cat' => $category2, 'no_found_rows' => TRUE));
			$p=0;
		...
		<div class="prl-span-4">
            ...
            <?php
			$recent_post3 = new WP_Query(array('post_type' => 'post','showposts' => 1,'post__not_in' => get_option('sticky_posts'),'cat' => $category3, 'no_found_rows' => TRUE));
			$p=0;
