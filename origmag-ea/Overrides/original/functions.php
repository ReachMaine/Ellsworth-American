...
function theme_scripts_function() {
	...
	wp_enqueue_style('Roboto-Slab', 'https://fonts.googleapis.com/css?family=Roboto+Slab');
	...
	if($prl_data['heading_font']!='none' && $prl_data['heading_font']!='Roboto Slab' && !in_array($prl_data['heading_font'], $fonts)):
		...
		wp_enqueue_style(str_replace(' ','-',$prl_data['heading_font']), 'https://fonts.googleapis.com/css?family='.str_replace(' ','+',$prl_data['heading_font']));
	endif;
