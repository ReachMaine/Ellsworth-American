...
function wpurp_minimal_mode( $minimal_mode, $url ) {
    ...
    // dont show for archives(usually category) or single pages or obits 
    if ( is_post_type_archive(array('page','obituary', 'post')) || is_singular(array('obituary', 'page')) ) return true;
    return false;
}
