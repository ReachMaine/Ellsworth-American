...
$meta->addSelect('cat_style',array('default'=>'Default', 'list'=>'List','2col'=>'2 Columns','3col' => '3 Columns', 'liv' => 'Living', 'subcats' => 'Subcat Desc'),array('name'=>'Category style','std'=>'default','desc'=>'Choose Default if you want to use default setting in Theme Options'));
