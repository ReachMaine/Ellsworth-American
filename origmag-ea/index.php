...
<div class="prl-container">
    ...
    /*   if(is_category() && isset($prl_data['banner_bot_cat']) && $prl_data['banner_bot_cat']!='') {
        echo '<div class="eai-ad-container eai-ad-across eai-cat-bottom">'.do_shortcode(stripslashes($prl_data['banner_bot_cat'])).'</div>';
      } */
    ?>
