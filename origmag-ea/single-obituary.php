<?php  /* template mods:
  ...
  7Mar17 zig - replace content bottom ad with new widget area
 */
?>
<?php get_header();?>
               ...
               <div class ="single-meta meta-bottom">
                 <div class="prl-article-meta">
                  ...
                  <hr class="prl-grid-divider">
						   ...
						   <?php /* zout 7Mar17 if(isset($prl_data['banner_after_single_content']) && $prl_data['banner_after_single_content']!='') echo '<div class="hide-mobile"><center class="ad-container ad-in-content">'.stripslashes($prl_data['banner_after_single_content']).'</center></div>';*/ ?>
